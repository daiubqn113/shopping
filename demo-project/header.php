							...
							<ul class="list-unstyled list-thumbs-pro">
								<li class="product">
									<div class="product-thumb-info">
										...
										<div class="product-thumb-info-image">
											<a href="shop-product-detail1.html"><img alt="" width="60" src="public/images/content/products/product-1.jpg"></a>
										</div>
								...
								<li class="product">
									<div class="product-thumb-info">
										<a href="#" class="product-remove"><i class="fa fa-trash-o"></i></a>
										<div class="product-thumb-info-image">
											<a href="shop-product-detail1.html"><img alt="" width="60" src="public/images/content/products/product-2.jpg"></a>
										</div>
								...
								<li class="product">
									<div class="product-thumb-info">
										<a href="#" class="product-remove"><i class="fa fa-trash-o"></i></a>
										<div class="product-thumb-info-image">
											<a href="shop-product-detail1.html"><img alt="" width="60" src="public/images/content/products/product-3.jpg"></a>
										</div>
			 ...
			 ?>
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown active"><a href="about.php" >about</a></li>
